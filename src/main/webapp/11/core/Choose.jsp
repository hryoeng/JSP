...
<%--  다중 조건을 판단할 때 사용  --%>
<%--<c:choose>--%>
<%--    <c:when test="조건1">조건 1 만족하는 경우</c:when>        &lt;%&ndash;if&ndash;%&gt;--%>
<%--    <c:when test="조건2">조건 2 만족하는 경우</c:when>        &lt;%&ndash;else if&ndash;%&gt;--%>
<%--    <c:when test="조건3">조건 3 만족하는 경우</c:when>        &lt;%&ndash;else&ndash;%&gt;--%>
<%--</c:choose>--%>
